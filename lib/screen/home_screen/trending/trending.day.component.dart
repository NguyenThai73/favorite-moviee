...
class TrendingDayComponent extends StatelessWidget {
  final List<MovieModel> listData;

  const TrendingDayComponent({super.key, required this.listData});
              ...
              : SizedBox(
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      return Container(
                        width: 175,
                        decoration: BoxDecoration(color: const Color.fromARGB(255, 224, 224, 224), borderRadius: BorderRadius.circular(10)),
                      );
                    },
                    separatorBuilder: (context, index) {
                      return const SizedBox(
